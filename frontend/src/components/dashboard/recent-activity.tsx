...
interface RecentActivityProps {
  uploads: { id: string; filename: string; row_count: number; created_at: string }[];
            ...
            uploads.map((u) => (
              <div key={u.id} className="flex items-center gap-3 p-3 rounded-lg bg-muted/30 hover:bg-muted/50 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">{u.row_count} rows</p>
                </div>
            ...
            reports.map((r) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <Badge variant="secondary" className="text-xs mt-0.5">{r.tone}</Badge>
                </div>
                <div className="flex items-center gap-1 text-xs text-muted-foreground">
                  <Clock className="h-3 w-3" />
